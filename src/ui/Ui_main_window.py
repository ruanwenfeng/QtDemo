...
# Form implementation generated from reading ui file 'c:\Users\admin\Documents\GitHub\QtDemo\src\ui\main_window.ui'
#
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.line.setGeometry(QtCore.QRect(40, 190, 521, 16))
        self.line.setFrameShape(QtWidgets.QFrame.HLine)
        self.line.setFrameShadow(QtWidgets.QFrame.Sunken)
        self.line.setObjectName("line")
        self.widget = QtWidgets.QWidget(self.centralwidget)
        self.widget.setGeometry(QtCore.QRect(20, 20, 581, 25))
        ...
        self.widget1.setGeometry(QtCore.QRect(40, 210, 77, 171))
        ...
        self.widget2.setGeometry(QtCore.QRect(130, 70, 245, 112))
        ...
        self.gridLayout.addWidget(self.pushButton_10, 0, 2, 1, 2)
        ...
        self.gridLayout.addWidget(self.pushButton_17, 3, 0, 1, 2)
        self.pushButton_13 = QtWidgets.QPushButton(self.widget2)
        self.pushButton_13.setObjectName("pushButton_13")
        self.gridLayout.addWidget(self.pushButton_13, 1, 2, 1, 2)
        self.pushButton_16 = QtWidgets.QPushButton(self.widget2)
        self.pushButton_16.setObjectName("pushButton_16")
        self.gridLayout.addWidget(self.pushButton_16, 2, 2, 1, 2)
        self.pushButton_19 = QtWidgets.QPushButton(self.widget2)
        self.pushButton_19.setObjectName("pushButton_19")
        self.gridLayout.addWidget(self.pushButton_19, 3, 2, 1, 2)
        self.widget3 = QtWidgets.QWidget(self.centralwidget)
        self.widget3.setGeometry(QtCore.QRect(210, 250, 391, 48))
        ...
        self.widget4.setGeometry(QtCore.QRect(230, 350, 491, 194))
        self.widget4.setObjectName("widget4")
        self.horizontalLayout_2 = QtWidgets.QHBoxLayout(self.widget4)
        self.horizontalLayout_2.setContentsMargins(0, 0, 0, 0)
        self.horizontalLayout_2.setObjectName("horizontalLayout_2")
        self.pushButton_18 = QtWidgets.QPushButton(self.widget4)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_2.setText(_translate("MainWindow", "name(&B)"))
